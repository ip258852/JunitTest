...
public class IssueBuilder {
    ...
    /**
     * 2. 並將方法creator(Long creatorNum), assignee(Long assigneeNum)內部設值方式，
     * 從this.creator = new Creator(creatorNum)修改為this.creatorNum = creatorNum
     */
    ...
    /**
     * 3. 將withResultResolved(Long closerNum), withResultReject(Long closerNum)內部設值的方式
     * this.closerNum = new Closer(closerNum)修改為this.closerNum = closerNum
     */
